        ...
        <section id="skills" className="relative flex flex-col items-center justify-center pt-20 mb-40 w-full">
          ...
          >
            ...
            >
              {/* Outer blurred glow */}
              <div
                className="absolute inset-[-2px] md:inset-[-3px] rounded-t-xl blur-[12px] opacity-70"
                style={{ background: 'linear-gradient(135deg, #00d2ff 0%, #a855f7 40%, #ec4899 70%, #f27121 100%)' }}
              />
              {/* Inner sharp gradient border base */}
              <div
                className="absolute inset-[-1px] md:inset-[-2px] rounded-t-xl"
                style={{ background: 'linear-gradient(135deg, #00d2ff 0%, #a855f7 40%, #ec4899 70%, #f27121 100%)' }}
              />
            </motion.div>
            ...
            <motion.div
              animate={{
                ...
                borderColor: isFolderHovered ? "rgba(229, 57, 53, 0.4)" : "rgba(229, 57, 53, 0)"
              }}
            ...
            <motion.div
              ...
              animate={{
                ...
                borderColor: isFolderHovered ? "rgba(229, 57, 53, 0.6)" : "rgba(229, 57, 53, 0)"
              }}
            ...
            >
              ...
              <motion.div
                animate={{ opacity: isFolderHovered ? 0 : 0.08 }}
                className="absolute inset-0 bg-gradient-to-br from-[#00d2ff] via-[#a855f7] to-[#f27121] pointer-events-none"
              />
