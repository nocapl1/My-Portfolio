...
export default function Home() {
  ...
  // --- THE AI BRAIN (You can edit these responses!) ---
  const handleAiSubmit = (e: React.FormEvent) => {
    ...
    // Simulate a network delay so it feels like real AI thinking
    setTimeout(() => {
        ...
        <section id="skills" className="relative flex flex-col items-center justify-center pt-20 mb-32 w-full">
          ...
          <div className="overflow-hidden border-b border-white/10 pb-4 mb-24 flex justify-between items-end relative w-full">
            ...
            >
              ...
              {/* --- GLOWING PILL BADGE --- */}
              <div className="relative hidden md:flex items-center bg-[#0a0a0a] border border-white/10 rounded-full pl-4 pr-6 py-1.5 overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
                ...
                <div className="relative mx-4 h-4 w-[2px] bg-[#e53935] z-10 shadow-[0_0_8px_#e53935]">
                  <motion.div 
                    animate={{ opacity: [0.4, 0.8, 0.4], width: ["50px", "80px", "50px"] }}
          ...
          >
            ...
            <div className="absolute inset-0 -z-10 pointer-events-none flex items-center justify-center">
              <motion.div 
                animate={{ opacity: isFolderHovered ? 0.8 : [0.3, 0.5, 0.3], scale: isFolderHovered ? 1.1 : [1, 1.05, 1] }}
                transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
                className="absolute w-[60%] h-[60%] bg-portfolioRed/10 rounded-full blur-[80px]"
              />
              <motion.div animate={{ rotate: 360 }} transition={{ repeat: Infinity, duration: 40, ease: "linear" }} className="absolute w-[500px] h-[500px] rounded-full border border-dashed border-white/5 opacity-50"/>
              <motion.div animate={{ rotate: -360 }} transition={{ repeat: Infinity, duration: 30, ease: "linear" }} className="absolute w-[650px] h-[650px] rounded-full border border-dotted border-portfolioRed/20 opacity-30"/>
            ...
            <motion.div 
              ...
              className="absolute bottom-0 w-[95%] md:w-[650px] h-[380px] bg-[#111] rounded-t-xl border-t border-l border-r z-0"
            />
                  ...
                  return (
                    <motion.div 
                      ...
                      animate={{
                        ...
                        boxShadow: isHovered ? `0 0 60px ${card.color}80, 0 20px 50px rgba(0,0,0,0.8)` : isFolderHovered ? `0 0 15px ${card.color}30` : "none",
                    ...
                    >
                      ...
                      >
                         <span className="font-mono text-[10px] md:text-xs text-white/80 uppercase tracking-widest group-hover:text-white transition-colors flex items-center gap-2">
                           <motion.span animate={{ boxShadow: (isHovered || isFolderHovered) ? `0 0 10px ${card.color}` : "none" }} className="w-1.5 h-1.5 rounded-full hidden md:block" style={{ backgroundColor: card.color }}></motion.span>
                           {card.title}
                         </span>
                      </motion.div>
                      ...
                      <div className="w-full h-full relative z-10 p-6 md:p-8 flex flex-col">
                        <div className="flex items-center gap-4 mb-6">
                           ...
                           <h3 className="font-serif text-2xl md:text-3xl text-white" style={{ textShadow: isHovered ? `0 0 20px ${card.color}40` : "none" }}>
                             {card.title}
                           </h3>
                        </div>
                          ...
                          {card.items.map((item, i) => (
                            <div key={i} className="flex flex-col gap-2">
                               ...
                               <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
                                  <motion.div 
                                    initial={{ width: 0 }}
                                    animate={{ width: isHovered ? `${item.level}%` : 0, boxShadow: isHovered ? `0 0 10px ${card.color}` : "none" }}
            ...
            <motion.div 
                ...
                className="absolute bottom-0 w-[95%] md:w-[650px] h-[380px] bg-gradient-to-t from-[#050505] to-[#1a1a1a] rounded-t-xl border-t border-l border-r z-40 flex items-center justify-center pointer-events-none"
            >
          ...
          {/* --- NEW RESPONSIVE AI PROMPT INPUT BOX --- */}
          <motion.div 
          ...
          >
            ...
            <div className="w-full relative">
              <div className="absolute -inset-[1px] bg-gradient-to-r from-orange-400 via-purple-500 to-blue-500 rounded-2xl opacity-30 blur-[4px] group-hover:opacity-60 transition duration-500 pointer-events-none"></div>
              ...
              <form onSubmit={handleAiSubmit} className="relative bg-[#0d0d0f] rounded-2xl p-3 flex flex-col gap-4 border border-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.8)] w-full">
                ...
                <div className="flex justify-between items-center px-1">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button type="button" className="px-3 py-1.5 rounded-full bg-white/5 hover:bg-white/10 hidden md:flex items-center justify-center text-white/70 text-xs gap-1.5 transition-colors border border-white/5">
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M12 2v1"/><path d="M12 7v1"/><path d="M12 12v1"/><path d="M15.5 4.5l-.7.7"/><path d="M8.5 4.5l.7.7"/><path d="M19 12h-1"/><path d="M6 12H5"/></svg>
                      DeepThink <span className="text-[10px] opacity-50 ml-1">⌄</span>
                    </button>
                  </div>
            ...
            <AnimatePresence>
              {(aiResponse || isAiTyping) && (
                <motion.div 
                  ...
                  className="w-[95%] bg-[#0d0d0f]/80 backdrop-blur-md rounded-xl p-5 mt-4 border border-white/5 shadow-xl overflow-hidden"
                >
                  {isAiTyping ? (
